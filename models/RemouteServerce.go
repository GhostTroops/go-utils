...
type RemouteServerce struct {
	...
	WhereAmI   `json:",inline"`
	Title      string `json:"title" gorm:"type:varchar(200);"`
	Ip         string ` gorm:"type:varchar(60);column:ip;unique_index:ip_port" yaml:"ip,omitempty" json:"ip,omitempty"  jsonschema:"title=ip or domain Required parameters for connection,description=ip or domain Required parameters for connection"`
...
func init() {
	util.RegInitFunc(func() {
		util.GetDb()
		util.InitModle(&Localnet{}, &IpInfo{}, &RemouteServerce{}, &DomainInfo{}, &DomainSite{}, &SubDomainItem{}, &Domain2Ips{}, &Ip2Ports{}, &ConnectInfo{}, &Task{}, &WifiInfo{}, &WifiLists{})
	})
}
